...
//! Scoped to discovery (FC=0 BASIC_INFO) + heartbeat (FC=6) only —
//! fragmentation, bulk parameter reads, and everything else are deliberately
//! out of scope for this pass (see `live/driver.rs`'s forward-looking note).
//!
